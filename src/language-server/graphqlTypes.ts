...
export type AccountBillingUsageStatsFilterIn = {
  ...
  operationSubtype: Maybe<Array<Maybe<Scalars["String"]>>>;
  ...
  operationType: Maybe<Array<Maybe<Scalars["String"]>>>;
...
export type AccountGraphosCloudMetricsFilter = {
  /** Selects rows whose agentVersion dimension equals the given value if not null. To query for the null value, use {in: {agentVersion: [null]}} instead. */
  agentVersion: Maybe<Scalars["String"]>;
  and: Maybe<Array<AccountGraphosCloudMetricsFilter>>;
  in: Maybe<AccountGraphosCloudMetricsFilterIn>;
  not: Maybe<AccountGraphosCloudMetricsFilter>;
  or: Maybe<Array<AccountGraphosCloudMetricsFilter>>;
...
export type AccountGraphosCloudMetricsFilterIn = {
  ...
  routerId: Maybe<Array<Maybe<Scalars["String"]>>>;
  /** Selects rows whose schemaTag dimension is in the given list. A null value in the list means a row with null for that dimension. */
  schemaTag: Maybe<Array<Maybe<Scalars["String"]>>>;
  /** Selects rows whose serviceId dimension is in the given list. A null value in the list means a row with null for that dimension. */
  serviceId: Maybe<Array<Maybe<Scalars["ID"]>>>;
...
export type AccountStatsWindowGraphosCloudMetricsArgs = {
  filter: Maybe<AccountGraphosCloudMetricsFilter>;
  limit?: Maybe<Scalars["Int"]>;
  orderBy: Maybe<Array<AccountGraphosCloudMetricsOrderBySpec>>;
};
...
export type AddCommentInput = {
  ...
  schemaCoordinate: Maybe<Scalars["String"]>;
  schemaScope: Maybe<Scalars["String"]>;
};
...
export type BillingPlanAddonInput = {
  ...
  usdCentsPrice: Maybe<Scalars["Int"]>;
};
...
export type BillingPlanInput = {
  ...
  clientVersions: Maybe<Scalars["Boolean"]>;
  clients: Maybe<Scalars["Boolean"]>;
  contracts: Maybe<Scalars["Boolean"]>;
  datadog: Maybe<Scalars["Boolean"]>;
  description: Scalars["String"];
  errors: Maybe<Scalars["Boolean"]>;
  federation: Maybe<Scalars["Boolean"]>;
  id: Scalars["ID"];
  kind: BillingPlanKind;
  launches: Maybe<Scalars["Boolean"]>;
  maxAuditInDays: Maybe<Scalars["Int"]>;
  maxRangeInDays: Maybe<Scalars["Int"]>;
  maxRangeInDaysForChecks: Maybe<Scalars["Int"]>;
  maxRequestsPerMonth: Maybe<Scalars["Long"]>;
  metrics: Maybe<Scalars["Boolean"]>;
  name: Scalars["String"];
  notifications: Maybe<Scalars["Boolean"]>;
  operationRegistry: Maybe<Scalars["Boolean"]>;
  persistedQueries: Maybe<Scalars["Boolean"]>;
  pricePerSeatInUsdCents: Maybe<Scalars["Int"]>;
  pricePerUnitInUsdCents: Maybe<Scalars["Int"]>;
  public: Scalars["Boolean"];
  schemaValidation: Maybe<Scalars["Boolean"]>;
  traces: Maybe<Scalars["Boolean"]>;
  userRoles: Maybe<Scalars["Boolean"]>;
...
export type CheckFilterInput = {
  ...
  includeProposalChecks: Maybe<Scalars["Boolean"]>;
...
export type CommentFilter = {
  schemaScope: Maybe<Scalars["String"]>;
  status: Maybe<Array<CommentStatus>>;
...
export type ComposeAndFilterPreviewResult =
...
export type CompositionBuildCheckFailed = BuildCheckFailed &
  BuildCheckResult &
  CompositionBuildCheckResult & {
...
export type CompositionBuildCheckPassed = BuildCheckPassed &
  BuildCheckResult &
  CompositionBuildCheckResult & {
...
export type CompositionCheckTask = BuildCheckTask &
  CheckWorkflowTask & {
...
export type CreateRouterVersionResult =
...
export type CreateShardInput = {
  aws: Maybe<CreateAwsShardInput>;
  fly: Maybe<CreateFlyShardInput>;
  gcuCapacity: Maybe<Scalars["Int"]>;
  gcuUsage: Maybe<Scalars["Int"]>;
  provider: CloudProvider;
  routerCapacity: Maybe<Scalars["Int"]>;
  routerUsage: Maybe<Scalars["Int"]>;
  shardId: Scalars["String"];
  status: Maybe<ShardStatus>;
  tier: CloudTier;
};
...
export type DeleteCommentSuccessResult =
  | ParentChangeProposalComment
  | ParentGeneralProposalComment;
...
export type DestroyRouterResult =
...
export type EndUsageBasedPlanResult =
  | Account
  | NotFoundError
  | PermissionError
  | ValidationError;
...
export type FieldInsightsListFilterInput = {
  clientName: Maybe<Scalars["String"]>;
  clientVersion: Maybe<Scalars["String"]>;
  in: Maybe<FieldInsightsListFilterInInput>;
  isDeprecated: Maybe<Scalars["Boolean"]>;
  isUnused: Maybe<Scalars["Boolean"]>;
  or: Maybe<Array<FieldInsightsListFilterInput>>;
...
export type FieldInsightsListItem = {
  ...
  p50LatencyMs: Scalars["Float"];
  p90LatencyMs: Scalars["Float"];
  p95LatencyMs: Scalars["Float"];
  p99LatencyMs: Scalars["Float"];
  parentType: Scalars["String"];
  referencingOperationCount: Scalars["Long"];
  referencingOperationCountPerMin: Scalars["Float"];
  /** @deprecated Use p50LatencyMs, p90LatencyMs, p95LatencyMs, or p99LatencyMs instead */
  totalLatencyHistogram: DurationHistogram;
};
...
export type FilterBuildCheckFailed = BuildCheckFailed &
  BuildCheckResult &
  FilterBuildCheckResult & {
...
export type FilterBuildCheckPassed = BuildCheckPassed &
  BuildCheckResult &
  FilterBuildCheckResult & {
...
export type FilterCheckTask = BuildCheckTask &
  CheckWorkflowTask & {
...
export type FlyForceRollingUpdateResult =
...
export type GraphLinterConfigurationChangesInput = {
  ...
  allowedTagNameAdditions: Maybe<Array<Scalars["String"]>>;
...
export type GraphVariantFieldInsightsListArgs = {
  after: Maybe<Scalars["String"]>;
  before: Maybe<Scalars["String"]>;
  filter: Maybe<FieldInsightsListFilterInput>;
  first: Maybe<Scalars["Int"]>;
  from: Scalars["Timestamp"];
  last: Maybe<Scalars["Int"]>;
  orderBy: Maybe<FieldInsightsListOrderByInput>;
  to: Scalars["Timestamp"];
};
...
export type GraphVariantOperationInsightsListArgs = {
  after: Maybe<Scalars["String"]>;
  before: Maybe<Scalars["String"]>;
  filter: Maybe<OperationInsightsListFilterInput>;
  first: Maybe<Scalars["Int"]>;
  from: Scalars["Timestamp"];
  last: Maybe<Scalars["Int"]>;
  orderBy: Maybe<OperationInsightsListOrderByInput>;
  to: Scalars["Timestamp"];
};
...
export type GraphosCloudMetricsFilter = {
  ...
  /** Selects rows whose agentVersion dimension equals the given value if not null. To query for the null value, use {in: {agentVersion: [null]}} instead. */
  agentVersion: Maybe<Scalars["String"]>;
  and: Maybe<Array<GraphosCloudMetricsFilter>>;
  in: Maybe<GraphosCloudMetricsFilterIn>;
  not: Maybe<GraphosCloudMetricsFilter>;
  or: Maybe<Array<GraphosCloudMetricsFilter>>;
  /** Selects rows whose routerId dimension equals the given value if not null. To query for the null value, use {in: {routerId: [null]}} instead. */
  routerId: Maybe<Scalars["String"]>;
  /** Selects rows whose schemaTag dimension equals the given value if not null. To query for the null value, use {in: {schemaTag: [null]}} instead. */
  schemaTag: Maybe<Scalars["String"]>;
...
export type LinkPersistedQueryListResultOrError =
...
export type OperationInsightsListFilterInput = {
  clientName: Maybe<Scalars["String"]>;
  clientVersion: Maybe<Scalars["String"]>;
  in: Maybe<OperationInsightsListFilterInInput>;
  isUnnamed: Maybe<Scalars["Boolean"]>;
  isUnregistered: Maybe<Scalars["Boolean"]>;
  operationTypes: Maybe<Array<OperationType>>;
  or: Maybe<Array<OperationInsightsListFilterInput>>;
  search: Maybe<Scalars["String"]>;
};
...
export type OperationInsightsListItem = {
  ...
  serviceTimeP50Ms: Scalars["Float"];
  serviceTimeP90Ms: Scalars["Float"];
  serviceTimeP95Ms: Scalars["Float"];
  serviceTimeP99Ms: Scalars["Float"];
  signatureBytes: Scalars["Long"];
  totalDurationMs: Scalars["Float"];
...
export type ParentChangeProposalComment = ChangeProposalComment &
  ProposalComment & {
...
export type ParentProposalComment =
  | ParentChangeProposalComment
  | ParentGeneralProposalComment;
...
export type PersistedQueryListMutationPublishOperationsArgs = {
  allowOverwrittenOperations: Maybe<Scalars["Boolean"]>;
  operations: Maybe<Array<PersistedQueryInput>>;
  removeOperations: Maybe<Array<Scalars["ID"]>>;
};
...
export type ProposalRevisionsWithChecksArgs = {
  filter: Maybe<ProposalRevisionFilterInput>;
  limit: Maybe<Scalars["Int"]>;
  offset: Maybe<Scalars["Int"]>;
};
...
export type ProposalCommentResult =
  | NotFoundError
  | ParentChangeProposalComment
  | ParentGeneralProposalComment
  | ReplyChangeProposalComment
...
export type ProposalMutation = {
  ...
  /** @deprecated use updateRequestedReviewers instead */
...
export type ProposalMutationSetRequestedReviewersArgs = {
  input: Maybe<SetRequestedReviewersInput>;
};
...
export type ProposalVariantsFilter = {
  ...
  status: Maybe<Array<ProposalStatus>>;
...
export type ProposedBuildInputChanges =
...
export type PushMarketoLeadInput = {
  ...
  Clearbit_LinkedIn_URL__c: Maybe<Scalars["String"]>;
  /** Company domain */
  Company_Domain__c: Maybe<Scalars["String"]>;
  /** GDPR Explicit Opt in */
  Explicit_Opt_in__c: Maybe<Scalars["Boolean"]>;
  /** GA Client ID */
  Google_User_ID__c: Maybe<Scalars["String"]>;
  /** GraphQL Production Stage */
  GraphQL_Production_Stage__c: Maybe<Scalars["String"]>;
  /** Job Function */
  Job_Function__c: Maybe<Scalars["String"]>;
  /** Lead Message */
  Lead_Message__c: Maybe<Scalars["String"]>;
  /** Lead Source Detail */
  Lead_Source_Detail__c: Maybe<Scalars["String"]>;
  /** Lead Source Most Recent Detail */
  Lead_Source_Most_Recent_Detail__c: Maybe<Scalars["String"]>;
  /** Lead Source Most Recent */
  Lead_Source_Most_Recent__c: Maybe<Scalars["String"]>;
  /** Referrer */
  Referrer__c: Maybe<Scalars["String"]>;
  /** Studio User Id */
  Studio_User_Id__c: Maybe<Scalars["String"]>;
  /** UTM Campaign First Touch */
  UTM_Campaign_First_Touch__c: Maybe<Scalars["String"]>;
  /** UTM Campaign */
  UTM_Campaign__c: Maybe<Scalars["String"]>;
  /** UTM ICID */
  UTM_ICID__c: Maybe<Scalars["String"]>;
  /** UTM Medium First Touch */
  UTM_Medium_First_Touch__c: Maybe<Scalars["String"]>;
  /** UTM Medium */
  UTM_Medium__c: Maybe<Scalars["String"]>;
  /** UTM Source First Touch */
  UTM_Source_First_Touch__c: Maybe<Scalars["String"]>;
  /** UTM Source */
  UTM_Source__c: Maybe<Scalars["String"]>;
  /** UTM Term */
  UTM_Term__c: Maybe<Scalars["String"]>;
  /** Company name */
...
export type ReplyChangeProposalComment = ChangeProposalComment &
  ProposalComment & {
...
export type RouterVersionConfigSchemaArgs = {
  tier: Maybe<CloudTier>;
};

/** Result of a RouterConfigVersion mutation */
export type RouterVersionConfigResult =
  | CloudInvalidInputError
  | InternalServerError
  | RouterConfigVersion;
...
export type RouterVersionResult =
  | InternalServerError
  | InvalidInputErrors
  | RouterVersion;
...
export type RouterVersionsResult =
  | InternalServerError
  | InvalidInputErrors
  | RouterVersions;
...
export type SchemaHashInput = {
  ...
  hash: Scalars["String"];
  subgraphs: Maybe<Array<SubgraphHashInput>>;
};
...
export type SchemaTagHistoryArgs = {
  ...
  limit?: Scalars["Int"];
  offset?: Maybe<Scalars["Int"]>;
  orderBy?: Maybe<SchemaTagHistoryOrder>;
};
...
export type ServiceFlatDiffArgs = {
  newSdlHash: Maybe<Scalars["SHA256"]>;
  oldSdlHash: Maybe<Scalars["SHA256"]>;
};
...
export type ServiceProposalVariantsArgs = {
  filterBy: Maybe<ProposalVariantsFilter>;
  limit: Maybe<Scalars["Int"]>;
  offset: Maybe<Scalars["Int"]>;
};
...
export type ServiceGraphosCloudMetricsFilter = {
  /** Selects rows whose agentVersion dimension equals the given value if not null. To query for the null value, use {in: {agentVersion: [null]}} instead. */
  agentVersion: Maybe<Scalars["String"]>;
  and: Maybe<Array<ServiceGraphosCloudMetricsFilter>>;
  in: Maybe<ServiceGraphosCloudMetricsFilterIn>;
  not: Maybe<ServiceGraphosCloudMetricsFilter>;
  or: Maybe<Array<ServiceGraphosCloudMetricsFilter>>;
  /** Selects rows whose routerId dimension equals the given value if not null. To query for the null value, use {in: {routerId: [null]}} instead. */
  routerId: Maybe<Scalars["String"]>;
  /** Selects rows whose schemaTag dimension equals the given value if not null. To query for the null value, use {in: {schemaTag: [null]}} instead. */
  schemaTag: Maybe<Scalars["String"]>;
...
export type ServiceMutationCreatePersistedQueryListArgs = {
  description: Maybe<Scalars["String"]>;
  linkedVariants: Maybe<Array<Scalars["String"]>>;
  name: Scalars["String"];
};
...
export type ServiceMutationUpdateCheckConfigurationArgs = {
  enableLintChecks: Maybe<Scalars["Boolean"]>;
  excludedClients: Maybe<Array<ClientFilterInput>>;
  excludedOperationNames: Maybe<Array<OperationNameFilterInput>>;
...
export type ServiceStatsWindowGraphosCloudMetricsArgs = {
  filter: Maybe<ServiceGraphosCloudMetricsFilter>;
  limit?: Maybe<Scalars["Int"]>;
  orderBy: Maybe<Array<ServiceGraphosCloudMetricsOrderBySpec>>;
};
...
export type SetMinProposalApproversInput = {
  minApprovers: Maybe<Scalars["Int"]>;
};

/** Represents the possible outcomes of a setNextVersion mutation */
export type SetNextVersionResult =
  | InternalServerError
  | InvalidInputErrors
  | RouterVersion;
...
export type SetProposalRolesInput = {
  create: Maybe<UserPermission>;
  edit: Maybe<UserPermission>;
};

export type SetProposalRolesResult =
  | PermissionError
  | Service
  | ValidationError;
...
export type SetRequestedReviewersResult =
  | PermissionError
  | Proposal
  | ValidationError;
...
export type StatsWindowGraphosCloudMetricsArgs = {
  filter: Maybe<GraphosCloudMetricsFilter>;
  limit?: Maybe<Scalars["Int"]>;
  orderBy: Maybe<Array<GraphosCloudMetricsOrderBySpec>>;
};
...
export type UnlinkPersistedQueryListResultOrError =
  | PermissionError
...
export type UpdateAwsShardInput = {
  ...
  iamRoleArn: Maybe<Scalars["String"]>;
  loadbalancerArn: Maybe<Scalars["String"]>;
  loadbalancerListenerArn: Maybe<Scalars["String"]>;
  loadbalancerSecurityGroupId: Maybe<Scalars["String"]>;
  permissionsBoundaryArn: Maybe<Scalars["String"]>;
...
export type UpdateFlyShardInput = {
  endpoint: Maybe<Scalars["String"]>;
  etcdEndpoints: Maybe<Array<Scalars["String"]>>;
...
export type UpdateRequestedReviewersInput = {
  reviewerUserIdsToAdd: Maybe<Array<Scalars["ID"]>>;
  reviewerUserIdsToRemove: Maybe<Array<Scalars["ID"]>>;
};
...
export type UpdateRouterResult =
  | InternalServerError
  | InvalidInputErrors
  | UpdateRouterSuccess;
...
export type UpdateRouterVersionResult =
  | CloudInvalidInputError
  | InternalServerError
  | RouterVersion;
...
export type UpdateShardInput = {
  aws: Maybe<UpdateAwsShardInput>;
  fly: Maybe<UpdateFlyShardInput>;
  gcuCapacity: Maybe<Scalars["Int"]>;
  gcuUsage: Maybe<Scalars["Int"]>;
  routerCapacity: Maybe<Scalars["Int"]>;
  routerUsage: Maybe<Scalars["Int"]>;
...
export type FrontendUrlRootQuery = {
  __typename?: "Query";
...
export type SchemaTagsAndFieldStatsQuery = {
  __typename?: "Query";
  service: Maybe<{
    __typename?: "Service";
    schemaTags: Maybe<Array<{ __typename?: "SchemaTag"; tag: string }>>;
    stats: {
      __typename?: "ServiceStatsWindow";
...
export type GetSchemaByTagQuery = {
  __typename?: "Query";
  service: Maybe<{
    __typename: "Service";
    schema: Maybe<{
      ...
      __schema: {
        __typename?: "IntrospectionSchema";
        queryType: { __typename?: "IntrospectionType"; name: Maybe<string> };
        mutationType: Maybe<{
          __typename?: "IntrospectionType";
          name: Maybe<string>;
        }>;
...
export type IntrospectionFullTypeFragment = {
  __typename?: "IntrospectionType";
  kind: Maybe<IntrospectionTypeKind>;
  name: Maybe<string>;
  description: Maybe<string>;
...
export type IntrospectionInputValueFragment = {
  __typename?: "IntrospectionInputValue";
  name: string;
  description: Maybe<string>;
  defaultValue: Maybe<string>;
...
export type IntrospectionTypeRefFragment = {
  __typename?: "IntrospectionType";
  kind: Maybe<IntrospectionTypeKind>;
  name: Maybe<string>;
  ofType: Maybe<{
